# ShiftWave — Claude Code guide

> This file mirrors `AGENTS.md` (single source of truth for agent behavior). Claude Code reads `CLAUDE.md`; the content below is identical to what Cursor reads from `AGENTS.md`.
